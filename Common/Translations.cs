            ...
            <KeyValuePair<TranslationString, string>>
            {
              new KeyValuePair<TranslationString, string>(TranslationString.PtcLoginFail, "Your PTC account is wrong password, or being lock, or not active"),
                ...
                new KeyValuePair<TranslationString, string>(TranslationString.EventPokemonEvolvedSuccess,
                    "{0,-12} to {1,-12} | XP: {2,4:###0} | Candies: {3,4:###0}"),
                ...
                new KeyValuePair<TranslationString, string>(TranslationString.EventPokemonTransferred,
                    "{0,-12} | CP: {1,4:###0}/{3,4:###0} | IV: {2,6:0.00}%/{4,6:0.00}% | Candies: {5,4:###0}"),
                new KeyValuePair<TranslationString, string>(TranslationString.EventPokemonUpgraded,
                    "{0,-12} | CP: {2,4:###0}/{4,4:###0} | IV: {3,6:0.00}%/{5,6:0.00}% | SD: {6,4:###0} | Candies: {7,4:###0} | Level: {1,4:0.0}"),

                new KeyValuePair<TranslationString, string>(TranslationString.EventItemRecycled, "{0,3:0}x {1}"),
                ...
                new KeyValuePair<TranslationString, string>(TranslationString.EventPokemonCaptureSuccess,
                    "({0}) | ({1}) {2,-12} | Lvl: {3,4:0.0} | CP:({4,4:###0}/{5,4:###0}) | IV: {6,6:0.00}% | Chance: {7,6:0.00}% | {8}m dist | with a {9,-10} ({10,3:##0} left) | XP: {11,4:###0} | SD: {12,4:###0} | {13} | lat: {14,11:0.000000} long: {15,11:0.000000} | Move1: {16,-15} Move2: {17,-15} | Rarity: {18,-10} | Capture Reason: {19} | Shiny: {20,-3} | Form: {21} | Costume: {22} | Sex: {23}"),
                new KeyValuePair<TranslationString, string>(TranslationString.EventPokemonCaptureFailed,
                    "({0}) | ({1}) {2,-12} | Lvl: {3,4:0.0} | CP:({4,4:###0}/{5,4:###0}) | IV: {6,6:0.00}% | Chance: {7,6:0.00}% | {8}m dist | with a {9,-10} ({10,3:##0} left) | XP: {11,4:###0} |                          | lat: {12,11:0.000000} long: {13,11:0.000000} | Move1: {14,-15} Move2: {15,-15} | Rarity :{16,-10}"),
                ...
                new KeyValuePair<TranslationString, string>(TranslationString.IncubatorPuttingEgg,
                    "Putting egg in incubator: {0,5:0.00} km left"),
                new KeyValuePair<TranslationString, string>(TranslationString.IncubatorStatusUpdate,
                    "Incubator status update:  {0,5:0.00} Km left of {1,5:0.00} Km egg."),
                new KeyValuePair<TranslationString, string>(TranslationString.IncubatorEggHatched,
                    "{0,5:0.00} Km egg has hatched: {1,-12} | Lvl: {2,4:0.0} | CP: ({3,4}/{4,4}) | IV: {5,6:0.00}% | XP: {6,4:###0} | SD: {7,4:###0} | Candies: {8,4:###0}"),
